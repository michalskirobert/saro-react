...
const Settings = () => {
  ...
  // const profile = useSelector(({ currentUser }: any) => currentUser);
  ...
  // const updateHobbies = (hobbies: string | string[]) => {
  ...
  //   });
  // };
  // const updateNative = (lang: string) => {
  //   return firestore.collection("users").doc(currentUser?.uid).update({
  //     nativeLang: lang,
  //   });
  // };
  ...
  //   });
  // };
  // const updateSurname = (name: string) => {
  //   return firestore.collection("users").doc(currentUser?.uid).update({
  //     name,
  //   });
  // };
  // const updateUsername = async (username: string): any => {
  ...
  //   });
  // };
  // const handleSubmit = (e: NDefaultReactTypes.TFormEvent): any => {
  //   const promises = [];
  //   e.preventDefault();
