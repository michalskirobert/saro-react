      ...
      <section className="footer-page">
        <div className="footer-page__content">
          ...
          <select placeholder="Language"
            ...
            onChange={e => dispatch(userActions.changeLanguage(e.target.value))}
            >
        ...
        <div className="footer-page__icons">
          ...
          {footerElements?.socialMedia.links.map((links, index) => {
            ...
            return <li key={index}><a href={link} target="_blank"><img src={imgURL} alt={title} className="social-media__icons"/></a></li>
          })}
